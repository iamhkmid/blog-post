  ...
  return (
    <div className="flex flex-col gap-6">
      {items.map((item) => (
        <div
          key={item}
          className="relative flex cursor-pointer flex-col overflow-hidden rounded-md bg-white px-6 py-4 shadow-sm transition-all duration-200 ease-in-out"
        >
          <div className="flex items-center gap-3">
            ...
            <div className="relative h-[11px] w-[150px] overflow-hidden rounded-md bg-slate-100 md:h-[15px]">
              <Shimmer />
            </div>
          </div>
          ...
          <div className="relative mt-3 min-h-[15px] w-[60px] overflow-hidden rounded-[20px] bg-slate-100 md:min-h-[18px] md:w-[70px]">
            <Shimmer />
          </div>
        </div>
      ))}
